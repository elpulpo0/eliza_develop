...
export const laikaCharacter: Character = {
    ...
    settings: {
        secrets: {
            TELEGRAM_BOT_TOKEN:process.env.TELEGRAM_BOT_TOKEN_LAIKA,
            MVX_PRIVATE_KEY:process.env.MVX_PRIVATE_KEY_LAIKA,
            TWITTER_USERNAME:process.env.TWITTER_USERNAME_LAIKA,
            TWITTER_USER_ID:process.env.TWITTER_USER_ID_LAIKA,
            TWITTER_PASSWORD:process.env.TWITTER_PASSWORD_LAIKA,
            TWITTER_EMAIL:process.env.TWITTER_EMAIL_LAIKA,
            ACCESS_TOKEN_MANAGEMENT_TO:process.env.ACCESS_TOKEN_MANAGEMENT_TO_LAIKA,
            TWITTER_TARGET_USERS:process.env.TWITTER_TARGET_USERS_LAIKA
        },
        voice: {
            model: "",
        },
